...
If you have trouble joining, email SAFS computing administrator Michael Parker ([safshelp\@uw.edu](mailto:safshelp@uw.edu){.email}).

-   SAFS social [safssocial\@uw.edu](mailto:safssocial@uw.edu){.email}: [join](http://mailman13.u.washington.edu/mailman/listinfo/safssocial)
-   SAFS job postings [safsjobs\@uw.edu](mailto:safsjobs@uw.edu){.email}: [join](http://mailman11.u.washington.edu/mailman/listinfo/safsjobs)
-   SAFS community Slack: [join](https://join.slack.com/t/safs-community/shared_invite/zt-he8uinsg-yd_BzsR8hnST~G4UtNZ_bw) (or email Steven Roberts [sr320\@uw.edu](mailto:sr320@uw.edu){.email})
...
-   [SAFS Graduate Program](https://fish.uw.edu/students/graduate-program/) — advising: Samantha Scherer ([iamsams\@uw.edu](mailto:iamsams@uw.edu){.email}); HR: Amy Fox ([amyfox\@uw.edu](mailto:amyfox@uw.edu){.email})
-   [FINS](https://fish.uw.edu/students/graduate-program/fins-fisheries-interdisciplinary-network-of-students/) — listserv [safsgrads\@uw.edu](mailto:safsgrads@uw.edu){.email}: [join](http://mailman11.u.washington.edu/mailman/listinfo/safsgrads); Slack: [join](https://join.slack.com/t/safsgrads/shared_invite/zt-fq8maniu-e3JNso80fuqnLzrhdiyAzA)
-   CoEnv grads listserv [environment_grads\@uw.edu](mailto:environment_grads@uw.edu){.email}: [join](http://mailman11.u.washington.edu/mailman/listinfo/environment_grads)
...
-   [UW Office of Postdoctoral Affairs](https://grad.uw.edu/for-students-and-post-docs/office-of-postdoctoral-affairs/) — listserv: email [uwopa\@uw.edu](mailto:uwopa@uw.edu){.email}
-   [UW College of the Environment Postdocs](https://environment.uw.edu/research/postdoctoral-fellows/) — listserv [environment_postdocs\@uw.edu](mailto:environment_postdocs@uw.edu){.email}: contact Anthony Salazar ([asalazar\@uw.edu](mailto:asalazar@uw.edu){.email})
-   [SAFS Postdocs](https://fish.uw.edu/faculty-research/research/postdoctoralscholars/) — listserv [safspostdocs\@uw.edu](mailto:safspostdocs@uw.edu){.email}: [join](http://mailman13.u.washington.edu/mailman/listinfo/safspostdocs)
