...
!!! tip "The one-line rule" Everything that matters lives in a **GitHub repository** under [RobertsLab](https://github.com/RobertsLab), on the lab servers, or in a shared lab account — **not** on your laptop, your personal cloud drive, or in your head. If it only exists in one of those places, move it before you go.
...
-   [ ] **Physical samples** (extractions, tissues, slides, plates) are labeled and logged in the [Roberts Lab Inventory System](https://robertslab.github.io/lab-inventory/), with freezer/box locations recorded. See the [Lab Inventory handbook page](Lab-Inventory.md) for related databases and guidance.
